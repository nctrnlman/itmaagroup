                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div>
                                                    ...
                                                    <input type="text" class="form-control" id="datepicker-deadline-input" name="due_date" placeholder="Enter due date" data-provider="flatpickr">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div>
                                            ...
                                            <button type="button" class="btn btn-success mt-3" data-bs-toggle="modal" data-bs-target="#inviteMembersModal">Invite Members</button>
                                        </div>
                                    </div>
                                    <!-- end card body -->
                                </div>
    ...
    addButtons[i].addEventListener('click', function() {
        ...
        if (!isExistingMember) {
            ...
            removeButton.addEventListener('click', function() {
                ...
                memberIds = memberIds.filter(id => id !== userIdnik); // Remove the member's IDNIK from the array
