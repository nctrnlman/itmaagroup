                        ...
                        <div class="col-xl-4">
                            <div class="card card-animate">
                                <div class="card-body">
                                    ...
                                    <div class="mt-4">
                                        <a href="{{ route('building-facilities.index') }}" class="btn btn-danger">Open
                        ...
                        <div class="col-xl-4">
                            <div class="card card-animate">
                                <div class="card-body">
                                    ...
                                    <div class="mt-4">
                                        <a href="{{ route('other-facilities.index') }}" class="btn btn-secondary">Open Other
                        ...
                        <div class="col-xl-4">
                            <div class="card card-animate">
                                <div class="card-body">
                                    ...
                                    <div class="mt-4">
                                        <a href="{{ route('stationary-facilities.index') }}" class="btn "
