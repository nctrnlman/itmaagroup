                        ...
                        <div>
                            ...
                            <h2 class="mt-4 ff-secondary fw-semibold">
                                <span class="counter-value"
                                    data-target="@if (session('user')['access_type'] === 'Admin' || session('user')['access_type'] === 'GA Building') {{ $totalTickets }}
                            @else
                                {{ $totalTickets }} @endif">
                                </span>
                            </h2>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h2 class="mt-4 ff-secondary fw-semibold">
                                <span class="counter-value"
                                    data-target='@if (session('user')['access_type'] === 'Admin' || session('user')['access_type'] === 'GA Building') {{ $pendingTickets }}
                            @else
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h2 class="mt-4 ff-secondary fw-semibold">
                                <span class="counter-value"
                                    data-target='@if (session('user')['access_type'] === 'Admin' || session('user')['access_type'] === 'GA Building') {{ $processTickets }}
                            @else
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h2 class="mt-4 ff-secondary fw-semibold">
                                <span class="counter-value"
                                    data-target=' @if (session('user')['access_type'] === 'Admin' || session('user')['access_type'] === 'GA Building') {{ $closedTickets }}
                            @else
                                {{ $closedTickets }} @endif'>
                                        ...
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                @if (session('user')['access_type'] === 'Admin' ||
                                                    ...
                                                    <li>
                                                        <a href="{{ route('building-facilities.detail', ['id_tiket' => $ticket->id_ga_building]) }}"
                                                    ...
                                                    <li>
                                                        <a href="#" class="dropdown-item edit-item-btn"
                                                            onclick="event.preventDefault(); showConfirmation('{{ $ticket->id_ga_building }}');">
                                                            <i class="fa fa-trash align-bottom me-2 text-muted"></i> Delete
                                                        </a>
                                                        <form id="delete-form-{{ $ticket->id_ga_building }}"
                                                            action="{{ route('building-facilities.delete', ['id_tiket' => $ticket->id_ga_building]) }}"
                                                ...
                                                @else
                                                    ...
                                                    @if ($ticket->status == 'Pending')
                                                        <li>
                                                            ...
                                                            <form id="delete-form-{{ $ticket->id_ga_facilities }}"
                                                                action="{{ route('building-facilities.delete', ['id_tiket' => $ticket->id_ga_building]) }}"
                                                                method="POST" style="display: none;">
                                                                @csrf
                                                                @method('DELETE')
    ...
    <div class="modal fade zoomIn" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 1070px;">
            <div class="modal-content border-0">
                ...
                <form action="{{ route('building-facilities.insert') }}" method="POST" id="myForm"
