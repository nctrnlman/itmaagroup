...
@section('content')
    ...
    <form action="{{ route('other-facilities.update', ['id_tiket' => $ticket->id_ga_other_facilities]) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md">
                                            <h4 class="fw-semibold pb-2">#{{ $ticket->id_ga_other_facilities }} - Other
    ...
    <div class="col-xxl-9">
        <div class="card" style="background-color: #b30000">
            ...
            <div class="card-body p-4">
                ...
                @else
                    <form action="{{ route('other-facilities.komentar') }}" method="POST" class="mt-3">
                        @csrf
                        <input type="hidden" name="id_tiket" value="{{ $ticket->id_ga_other_facilities }}">
                        <div class="row g-3">
                            <div class="col-lg-12">
                            ...
                            <div class="d-flex align-items-center border border-dashed p-2 rounded mt-2">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <small class="text-muted">
                                        {{ Helper::formatSizeUnits(filesize(storage_path('app/public/gaOther/' . $lampiran))) }}
                                    </small>
                                </div>
                                <div class="hstack gap-3 fs-16">
                                    <a href="{{ route('download', ['folder' => 'gaOther', 'filename' => $lampiran]) }}"
                                        class="text-muted">
        ...
        @if (session('user')['access_type'] !== 'Admin' || session('user')['access_type'] !== 'GA Other Facilities')
            <div class="col-lg-12">
                <div class="hstack gap-2 justify-content-end">
                    <a href="{{ route('other-facilities.index') }}" class="btn btn-soft-success">Cancel</a>
                </div>
            </div>
        @endif
        <!--end col-->
