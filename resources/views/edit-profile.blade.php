                ...
                <div class="card-body p-4">
                    <div class="text-center mb-3">
                        <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                            <img src="@if ($employee->file_foto == null) {{ asset('uploads/uploads/default.jpg') }}  @else http://eip.maagroup.co.id/file/profile/{{ $employee->file_foto }} @endif"
                                class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image">
                            <div class="avatar-xs p-0 rounded-circle profile-photo-edit">
                                <form method="POST"
                                    action="{{ route('employee.photoProfile', ['idnik' => $employee->idnik]) }}"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <input type="text" value="{{ $employee->idnik }}" name="idnik" hidden>
                        ...
                        <h5 class="fs-16 mb-1">{{ $employee->nama }}</h5>
                        <p class="text-muted mb-0">{{ $employee->divisi }} / {{ $employee->position }}</p>
                ...
                <div class="card-body p-4">
                    <div class="tab-content">
                        <div class="tab-pane active" id="personalDetails" role="tabpanel">
                            <form action="{{ route('employee.update', ['idnik' => $employee->idnik]) }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="firstnameInput" class="form-label"> Name</label>
                                            <input hidden type="text" name="idnik" value="{{ $employee->idnik }}">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="hstack gap-2 justify-content-end">
                                            ...
                                            {{-- <a href="{{ route('employees') }}"  class="btn btn-soft-success">Cancel</a> --}}
                                        </div>
                                    </div>
                                    <!--end col-->
                                </div>
                        ...
                        <div class="tab-pane" id="changePassword" role="tabpanel">
                            <form action="{{ route('changePassword', ['idnik' => $employee->idnik]) }}" method="POST">
                                @csrf
                                <div class="row g-2">
                                    <div class="col-lg-4">
                                        <div>
