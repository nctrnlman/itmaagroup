                                                    ...
                                                    <div>
                                                        <select class="form-select" name="kategori_tiket"
                                                            ...
                                                            <option value="Building Management"
                                                                <?php echo e($ticket->kategori_tiket == 'Building Management' ? 'selected' : ''); ?>>
                                                                Building Management</option>
                                                            <option value="Repair & Purchase"
                                                                <?php echo e($ticket->kategori_tiket == 'Repair & Purchase' ? 'selected' : ''); ?>>
                ...
                <?php $__currentLoopData = [$ticket->lampiran1, $ticket->lampiran2]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lampiran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($lampiran): ?>
                        <div class="d-flex align-items-center border border-dashed p-2 rounded mt-2">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h6 class="mb-1">
                                    <a href="<?php echo e(asset('storage/gafacilities/' . $lampiran)); ?>">Lampiran
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\eip-it\resources\views/facilities/ga-facilities-detail.blade.php ENDPATH**/ ?>