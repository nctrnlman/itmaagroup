...
<div class="card-body p-4">
    ...
    <?php else: ?>
        <form action="<?php echo e(route('it-helpdesk.komentar')); ?>" method="post">
    <?php echo csrf_field(); ?>
                ...
                <?php $__currentLoopData = [$ticket->lampiran1, $ticket->lampiran2]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lampiran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($lampiran): ?>
                        <div class="d-flex align-items-center border border-dashed p-2 rounded mt-2">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h6 class="mb-1">
                                    <a href="<?php echo e(asset('storage/ithelpdesk/' . $lampiran)); ?>">Material Request Form
                                        </a>
                                </h6>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ptma5063/public_html/eip.maagroup.co.id/ticket/resources/views/it-helpdesk-detail.blade.php ENDPATH**/ ?>