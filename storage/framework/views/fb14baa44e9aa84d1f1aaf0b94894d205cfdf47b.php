...
<?php $__env->startSection('content'); ?>
    <div class="auth-page-wrapper pt-5">
        ...
        <div class="auth-one-bg-position auth-one-bg" id="auth-particles">
            <div class="bg-overlay" style="background-color: #b30000;"></div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\eip-testing\resources\views/auth/login.blade.php ENDPATH**/ ?>