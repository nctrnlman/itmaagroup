                        ...
                        <div>
                            ...
                            <h2 class="mt-4 ff-secondary fw-semibold">
                                <span class="counter-value"
                                    data-target="<?php if(session('user')['access_type'] === 'Admin' || session('user')['access_type'] === 'GA Building'): ?> <?php echo e($totalTickets); ?>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h2 class="mt-4 ff-secondary fw-semibold">
                                <span class="counter-value"
                                    data-target='<?php if(session('user')['access_type'] === 'Admin' || session('user')['access_type'] === 'GA Building'): ?> <?php echo e($pendingTickets); ?>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h2 class="mt-4 ff-secondary fw-semibold">
                                <span class="counter-value"
                                    data-target='<?php if(session('user')['access_type'] === 'Admin' || session('user')['access_type'] === 'GA Building'): ?> <?php echo e($processTickets); ?>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h2 class="mt-4 ff-secondary fw-semibold">
                                <span class="counter-value"
                                    data-target=' <?php if(session('user')['access_type'] === 'Admin' || session('user')['access_type'] === 'GA Building'): ?> <?php echo e($closedTickets); ?>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($ticket->id_ga_building); ?></td>
                                        ...
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <?php if(session('user')['access_type'] === 'Admin' ||
                                                    ...
                                                    <li>
                                                        <a href="<?php echo e(route('building-facilities.detail', ['id_tiket' => $ticket->id_ga_building])); ?>"
                                                    ...
                                                    <li>
                                                        <a href="#" class="dropdown-item edit-item-btn"
                                                            onclick="event.preventDefault(); showConfirmation('<?php echo e($ticket->id_ga_building); ?>');">
                                                            <i class="fa fa-trash align-bottom me-2 text-muted"></i> Delete
                                                        </a>
                                                        <form id="delete-form-<?php echo e($ticket->id_ga_building); ?>"
                                                            action="<?php echo e(route('building-facilities.delete', ['id_tiket' => $ticket->id_ga_building])); ?>"
    ...
    <div class="modal fade zoomIn" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 1070px;">
            <div class="modal-content border-0">
                ...
                <form action="<?php echo e(route('building-facilities.insert')); ?>" method="POST" id="myForm"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\it\ticket\resources\views/facilities/building-facilities.blade.php ENDPATH**/ ?>