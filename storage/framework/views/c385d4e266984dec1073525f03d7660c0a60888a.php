...
<?php $__env->startSection('content'); ?>
    <div class="auth-page-wrapper pt-5">
        ...
        <div class="auth-one-bg-position auth-one-bg" id="auth-particles">
            <div class="bg-overlay" style="background-color: #af2a25;"></div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ptma5063/public_html/eip.maagroup.co.id/ticket/resources/views/auth-logout-basic.blade.php ENDPATH**/ ?>