...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('building-facilities.update', ['id_tiket' => $ticket->id_ga_building])); ?>" method="POST">
        <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md">
                                            <h4 class="fw-semibold pb-2">#<?php echo e($ticket->id_ga_building); ?> - Building
                                                Maintenance
                                                Support
                                            </h4>
    ...
    <div class="col-xxl-9">
        <div class="card" style="background-color: #b30000; color:white">
            <div class="card-body p-4">
                ...
                <p class="text-muted" style="color: white"><?php echo $ticket->description; ?></p>
            ...
            <div class="card-body p-4">
                ...
                <?php else: ?>
                    <form action="<?php echo e(route('building-facilities.komentar')); ?>" method="POST" class="mt-3">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="id_tiket" value="<?php echo e($ticket->id_ga_building); ?>">
                        <div class="row g-3">
                            <div class="col-lg-12">
                    ...
                    <table class="table table-borderless align-middle mb-0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($ticket->end_date ? date('Y-m-d', strtotime($ticket->end_date)) : '-'); ?>
                            ...
                            <div class="d-flex align-items-center border border-dashed p-2 rounded mt-2">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <small class="text-muted">
                                        <?php echo e(Helper::formatSizeUnits(filesize(storage_path('app/public/gaBuilding/' . $lampiran)))); ?>

                                    </small>
                                </div>
                                <div class="hstack gap-3 fs-16">
                                    <a href="<?php echo e(route('download', ['folder' => 'gaBuilding', 'filename' => $lampiran])); ?>"
                                        class="text-muted">
        ...
        <?php if(session('user')['access_type'] !== 'Admin' || session('user')['access_type'] !== 'IT'): ?>
            <div class="col-lg-12">
                <div class="hstack gap-2 justify-content-end">
                    <a href="<?php echo e(route('building-facilities.index')); ?>" class="btn btn-soft-success">Cancel</a>
                </div>
            </div>
        <?php endif; ?>
        <!--end col-->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\it\ticket\resources\views/facilities/building-facilities-detail.blade.php ENDPATH**/ ?>