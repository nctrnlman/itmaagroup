                            ...
                            <div class="col-lg-4">
                                <div class="mb-3 mb-lg-0">
                                    ...
                                    <select class="form-select" data-choices id="choices-status-input" name="status">
                                        <option value="Open" <?php echo e($project->status === 'Open' ? 'selected' : ''); ?>>Open
                                        </option>
                                        <option value="On Progress"
                                            <?php echo e($project->status === 'On Progress' ? 'selected' : ''); ?>>On Progress</option>
                                        <option value="Closed" <?php echo e($project->status === 'Closed' ? 'selected' : ''); ?>>Closed
                                        </option>
                                        <option value="Rejected" <?php echo e($project->status === 'Rejected' ? 'selected' : ''); ?>>
                                            Canceled</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div>
                                    ...
                                    <select class="form-select" data-choices id="choices-status-input" name="categories">
                                        ...
                                        <option
                                            value="Hardware"<?php echo e($project->categories === 'Hardware' ? ' selected' : ''); ?>>
                                            Hardware</option>
                                        <option value="Network"<?php echo e($project->categories === 'Network' ? ' selected' : ''); ?>>
                                            Network</option>
                                        <option
                                            value="Printer & Scanner"<?php echo e($project->categories === 'Printer & Scanner' ? ' selected' : ''); ?>>
                                            Printer & Scanner</option>
                                        <option
                                            value="Software"<?php echo e($project->categories === 'Software' ? ' selected' : ''); ?>>
                                            Software</option>
                                        <option
                                            value="Programming"<?php echo e($project->categories === 'Programming' ? ' selected' : ''); ?>>
                                            Programming</option>
                                        <option
                                            value="Infrastruktur"<?php echo e($project->categories === 'Infrastruktur' ? ' selected' : ''); ?>>
                                            Infrastruktur</option>
                                        <option value="CCTV"<?php echo e($project->categories === 'CCTV' ? ' selected' : ''); ?>>CCTV
                                        </option>
                                        <option value="Server"<?php echo e($project->categories === 'Server' ? ' selected' : ''); ?>>
                                            Server</option>
                                    </select>
                                </div>
                            </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            costInput.value = '<?php echo e($project->cost ? 'Rp ' . number_format($project->cost, 0, ',', '.') : ''); ?>';
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ptma5063/public_html/eip.maagroup.co.id/ticket/resources/views/project/project-edit.blade.php ENDPATH**/ ?>