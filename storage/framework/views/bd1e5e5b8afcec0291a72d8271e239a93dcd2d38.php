...
<?php $__env->startSection('content'); ?>
    ...
    <div class="pt-4 mb-4 mb-lg-3 pb-lg-4">
        <div class="row g-4">
            <div class="col-auto">
                <div class="avatar-lg">
                    <img src="<?php echo e($employee->file_foto < 1 ? asset('uploads/uploads/default.jpg') : asset('uploads/uploads/' . $employee->file_foto)); ?>"
            ...
            <div class="col">
                <div class="p-2">
                    <h3><?php echo e($employee->nama); ?></h3>
                    <p><?php echo e($employee->divisi); ?></p>
            ...
            <div>
                <div class="d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <a href="/employee/update/<?php echo e($employee->idnik); ?>" class="btn btn-success"><i
                                            ...
                                            <table class="table table-borderless mb-0">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-muted"><?php echo e($employee->idnik); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th class="ps-0" scope="row">Full Name :</th>
                                                        <td class="text-muted"><?php echo e($employee->nama); ?></td>
                                                    </tr>

                                                    <tr>
                                                        <th class="ps-0" scope="row">E-mail :</th>
                                                        <td class="text-muted"><?php echo e($employee->username); ?></td>
                                                    </tr>

                                                    <tr>
                                                        <th class="ps-0" scope="row">Location :</th>
                                                        <td class="text-muted">
                                                            <?php echo e($employee->lokasi); ?>

                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th class="ps-0" scope="row">Joining Date : </th>
                                                        <td class="text-muted"><?php echo e($employee->doh); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th class="ps-0" scope="row">Status : </th>
                                                        <td class="text-muted"><?php echo e($employee->status); ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                            ...
                                            <div class="col-6 col-md-4">
                                                <div class="d-flex mt-4">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        ...
                                                        <h6 class="text-truncate mb-0"><?php echo e($employee->company); ?></h6>
                                                    </div>
                                                </div>
                                                <div class="d-flex mt-4">
                                                    <div class="flex-shrink-0 avatar-xs align-self-center me-3">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        ...
                                                        <h6 class="text-truncate mb-0"><?php echo e($employee->lokasi); ?></h6>
                                                    </div>
                                                </div>
                                                <div class="d-flex mt-4">
                                                    <div class="flex-shrink-0 avatar-xs align-self-center me-3">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        ...
                                                        <h6 class="text-truncate mb-0"><?php echo e($employee->divisi); ?></h6>
                                                    </div>
                                                </div>
                                                <div class="d-flex mt-4">
                                                    <div class="flex-shrink-0 avatar-xs align-self-center me-3">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        ...
                                                        <h6 class="text-truncate mb-0"><?php echo e($employee->departement); ?></h6>
                                                    </div>
                                                </div>
                                                <div class="d-flex mt-4">
                                                    <div class="flex-shrink-0 avatar-xs align-self-center me-3">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        ...
                                                        <h6 class="text-truncate mb-0"><?php echo e($employee->section); ?></h6>
                                                    </div>
                                                </div>
                                                <div class="d-flex mt-4">
                                                    <div class="flex-shrink-0 avatar-xs align-self-center me-3">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        ...
                                                        <h6 class="text-truncate mb-0"><?php echo e($employee->position); ?></h6>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-6 col-md-4">
                                                <div class="d-flex mt-4">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        ...
                                                        <h6 class="text-truncate mb-0"><?php echo e($employee->clasifikasi); ?></h6>
                                                    </div>
                                                </div>
                                                <div class="d-flex mt-4">
                                                    <div class="flex-shrink-0 avatar-xs align-self-center me-3">
                                                ...
                                                <div class="d-flex mt-4">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <p class="mb-1">POH </p>
                                                        <h6 class="text-truncate mb-0"><?php echo e($employee->poh); ?></h6>
                                                    </div>
                                                </div>
                                                <div class="d-flex mt-4">
                                                    <div class="flex-shrink-0 avatar-xs align-self-center me-3">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        ...
                                                        <h6 class="text-truncate mb-0"><?php echo e($employee->roster); ?></h6>
                                                    </div>
                                                </div>
                                                <div class="d-flex mt-4">
                                                    <div class="flex-shrink-0 avatar-xs align-self-center me-3">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <p class="mb-1">DOH </p>
                                                        <h6 class="text-truncate mb-0"><?php echo e($employee->doh); ?></h6>
                                                    </div>
                                                </div>
                                                <div class="d-flex mt-4">
                                                    <div class="flex-shrink-0 avatar-xs align-self-center me-3">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        ...
                                                        <h6 class="text-truncate mb-0"><?php echo e($employee->status); ?></h6>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\eip-it\resources\views/view-employee.blade.php ENDPATH**/ ?>