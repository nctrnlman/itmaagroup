                                    ...
                                    <div class="col-md">
                                        <div>
                                            ...
                                            <div class="hstack gap-3 flex-wrap">
                                                ...
                                                <div class="vr"></div>
                                                <div>Start Date : <span
                                                        class="fw-medium"><?php echo e($project->start_date ? date('d F Y', strtotime($project->start_date)) : '-'); ?></span>
                                                </div>
                                                <div class="vr"></div>
                                                <div>Due Date : <span
                                                        class="fw-medium"><?php echo e($project->due_date ? date('d F Y', strtotime($project->due_date)) : '-'); ?></span>
                                                </div>
                                                <div class="vr"></div>
                                                <div>Status : <span class="fw-medium"><?php echo e($project->status ?: '-'); ?></span>
                                                </div>
                                                <div class="vr"></div>
                                                <div>Cost : <span class="fw-medium"
                                                        id="cost"><?php echo e($project->cost ? 'Rp ' . number_format($project->cost, 0, ',', '.') : '-'); ?></span>
                                                </div>
                                            </div>
                                        </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        const cost = <?php echo e($project->cost); ?>;
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ptma5063/public_html/eip.maagroup.co.id/ticket/resources/views/project/project-view.blade.php ENDPATH**/ ?>