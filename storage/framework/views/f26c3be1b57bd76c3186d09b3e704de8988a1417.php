                ...
                <table id="exampleee" class="display table table-bordered dt-responsive" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($employee->idnik); ?></td>
                            <td>
                            ...
                            <td><?php echo e($employee->divisi); ?></td>
                            <td><?php echo e($employee->lokasi); ?></td>
                            <td>
                                <div class="dropdown d-inline-block">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a href="/employee/view/<?php echo e($employee->idnik); ?>" class="dropdown-item"><i
                                                    class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a>
                                        </li>
                                        <li><a  href="/employee/update/<?php echo e($employee->idnik); ?>" class="dropdown-item edit-item-btn"><i
...
<div class="modal fade zoomIn" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0">
            ...
            <form action="<?php echo e(route('employees.insert')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\eip-it\resources\views/employees.blade.php ENDPATH**/ ?>